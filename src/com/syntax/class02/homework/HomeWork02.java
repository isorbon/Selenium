...
public class HomeWork02 {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("lastname")).sendKeys("Gold");
        driver.findElement(By.name("reg_email__")).sendKeys("john_gggol@gmail.com");
        driver.findElement(By.name("reg_email_confirmation__")).sendKeys("john_gggol@gmail.com");
        ...
        //driver.findElement(By.cssSelector("img[class='_8idr']")).click();
        Thread.sleep(3000);
        driver.quit();
